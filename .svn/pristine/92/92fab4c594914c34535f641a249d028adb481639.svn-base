"""
Django settings for MDChecker project.
...
SECRET_KEY = 'django-insecure-9ra7z0ow$_2jr6d@e*=b13xss#r58aw0#=4(c8)pw@t_&5nmup'
...
WSGI_APPLICATION = 'MDChecker.wsgi.application'
